    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                url: "/barhaaram/requisicoes.php?funcao=listartodaspresencas", 
        ...
        $(".confirmar-exclusao").click(function() {
            ...
            var id = $("#id-exclusao").val()
                ...
                $.ajax({
                    ...
                    url: "/barhaaram/requisicoes.php?funcao=excluirpresenca&id="+id, 
        ...
        $(".enviar-correcao").click(function() {
            ...
            if($("#inputNome").val() == ''){
                ...
                $.ajax({
                    ...
                    url: "/barhaaram/requisicoes.php?funcao=atualizapresenca&id="+id+"&nome="+nome+"&telefone="+telefone+"&email="+email+"&cpf="+cpf+"&data="+data, 
        ...
        function editar(id){
            ...
            $.ajax({
                ...
                url: "/barhaaram/requisicoes.php?funcao=buscapresencaporid&id="+id, 
        ...
        <div class="modal fade" id="editarModal" tabindex="-1" role="dialog" aria-labelledby="editarModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="editarModalLabel">Registro de Presenção </h5>
                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="nome" class="form-control" id="modal-inputData" placeholder="" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <input type="nome" class="form-control" id="modal-inputCpf" placeholder="">
